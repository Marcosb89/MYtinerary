  ...
  return (
    <div className='viewMore'>
      ...
      <Collapse isOpen={isOpen}>
        <Card>
          <CardBody>
            <h2 style={{textAlign:'left', fontSize:'5vw', marginTop: '-2vh'}}>
              Activities</h2>
            ...
            <input type="image" src={require('../assets/images/arrow2.png')} alt="Submit Form"
             style={{float:'right', marginTop: '-1.25vh', width:'3vw', height:'4vw'}}/>
          </CardBody>
        </Card>
      </Collapse>
    </div>
  ...
  activitiesHeader(){
    ...
    return(
      <div id='mainItineraryHeader'>
        ...
        <img id='mainItineraryImg' src={require('../assets/images/'+ urlImg)} 
...
const mapDispatchToProps = dispatch => {
  return {
    getItineraryData: data => {return dispatch(getItineraryData(data))
    }
  }
}
