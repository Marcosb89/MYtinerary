	...
	render(){
		return(
			<main className='MainLanding'>
				<p>Find your perfect trip, designed by insiders who know and 
					love their cities.</p>
				<Link to='/Cities'><img src={require("../assets/images/arrow.png")} alt="arrow"
				id='arrow'/></Link>
			</main>
		)
	}
				...
				<div id='contCarousel'>
					<div id='imgs'>
						<div id='img1'>
							...
							<CarouselCaption captionHeader={item.caption1} />   
						</div>
						<div id='img2'>
							<img src={item.src2} alt={item.altText2} />
							<CarouselCaption captionHeader={item.caption2} />   
						</div>
						<div id='img3'>
							<img src={item.src3} alt={item.altText3} />
							<CarouselCaption captionHeader={item.caption3} />   
						</div>
						<div id='img4'>
							<img src={item.src4} alt={item.altText4} />
							<CarouselCaption captionHeader={item.caption4} />
						</div>
